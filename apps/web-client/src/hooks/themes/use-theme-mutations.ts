...
//   toast.error(`Failed to ${operation} theme: ${getErrorMessage(error)}`);
...
//       toast.success(
//         `Theme created: ${data.name}" has been created successfully. `
//       );
//     },
//     onError: (error) => {
//       if (error.name === "ThemeLimitError") {
//         toast.error(
//           `Theme limit reached: You have reached the limit of ${MAX_FREE_THEMES} themes.`
//         );
//       } else {
...
//       });
//       toast.success(
//         `Theme updated: "${data.name}" has been updated successfully.`
//       );
//     },
...
//       toast.success(
//         `Theme deleted: "${data.name}" has been deleted successfully.`
//       );
